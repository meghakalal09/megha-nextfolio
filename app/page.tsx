  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <p>
          My work has been a mix of backend systems, data analytics, cloud
          infrastructure, and digital transformation. Along the way, I've delved
          into business areas like project planning, system architecture, and
          implementation strategy, the parts that make technology not just
          buildable, but truly usable.
        </p>
        <p>
