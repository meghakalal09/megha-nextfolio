...
export const experience: Experience[] = [
  {
    ...
    bullets: [
      "Assisting Dr. Bharti Motwani in designing projects on HDFS, Apache Spark, Neo4j, and MapReduce concepts under Cloud Computing course.",
      "Guiding a cohort of 60+ students through advanced technical concepts during office hours, offering support on implementation challenges related to big data processing.",
    ],
  },
  {
    ...
    bullets: [
      "Processed large-scale student application datasets using Python, automating data validation, award allocation workflows, and email lists with high accuracy and efficiency.",
